...
// Crear alumnos
var alumno1 = new Alumnos_1.Alumno("Marcelo", 8);
var alumno2 = new Alumnos_1.Alumno("Diana", 6);
var alumno3 = new Alumnos_1.Alumno("Juan", 9);
// Crear profesor
var profesor1 = new Profesores_1.Profesor("Profe Karen");
var profesor2 = new Profesores_1.Profesor("Profe Mauri");
...
console.log("Profes después de despedir");
